...
#include "sensor_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_c.h"
...
using _PID__ros_msg_type = sensor_interfaces__msg__PID;
...
size_t get_serialized_size_sensor_interfaces__msg__PID(
  const void * untyped_ros_message,
...
static uint32_t _PID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sensor_interfaces__msg__PID(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensor_interfaces
size_t max_serialized_size_sensor_interfaces__msg__PID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_interfaces__msg__PID;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
static size_t _PID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensor_interfaces__msg__PID(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensor_interfaces, msg, PID)() {
