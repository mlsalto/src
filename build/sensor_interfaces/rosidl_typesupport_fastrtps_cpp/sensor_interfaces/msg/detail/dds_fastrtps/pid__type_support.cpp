...
#include "sensor_interfaces/msg/detail/pid__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_interfaces::msg::PID;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const sensor_interfaces::msg::PID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_interfaces::msg::PID *>(
    untyped_ros_message);
...
{
  return &sensor_interfaces::msg::typesupport_fastrtps_cpp::_PID__handle;
}
