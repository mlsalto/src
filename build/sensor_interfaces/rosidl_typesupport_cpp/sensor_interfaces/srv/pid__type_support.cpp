...
static const _PID_Request_type_support_symbol_names_t _PID_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_interfaces, srv, PID_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interfaces, srv, PID_Request)),
  }
};
...
{
  return &::sensor_interfaces::srv::rosidl_typesupport_cpp::PID_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_interfaces, srv, PID_Request)() {
  return get_message_type_support_handle<sensor_interfaces::srv::PID_Request>();
}
...
static const _PID_Response_type_support_symbol_names_t _PID_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_interfaces, srv, PID_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interfaces, srv, PID_Response)),
  }
};
...
{
  return &::sensor_interfaces::srv::rosidl_typesupport_cpp::PID_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_interfaces, srv, PID_Response)() {
  return get_message_type_support_handle<sensor_interfaces::srv::PID_Response>();
}
...
static const _PID_type_support_symbol_names_t _PID_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_interfaces, srv, PID)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_interfaces, srv, PID)),
  }
};
...
{
  return &::sensor_interfaces::srv::rosidl_typesupport_cpp::PID_service_type_support_handle;
}
